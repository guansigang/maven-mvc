 ...
 *
 */
public class AutoMybatisEclipse {
	...
	public static void main(String[] args) {
		...
		try {
			auto(MyPath.getRealPath() + "/com/chens/web/auto/cfg/generator-config-eclipse.xml");
		} catch (Exception e) {
			e.printStackTrace();
	...
	private static void auto(String configUrl) throws Exception {
		log = LoggerFactory.getLogger(AutoMybatisEclipse.class);
