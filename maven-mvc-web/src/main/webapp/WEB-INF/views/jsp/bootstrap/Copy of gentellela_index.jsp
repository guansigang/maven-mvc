                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="bootstrap/bootstrapToPage?pageFlag=analysis_daletou">跳转测试1</a></li>
                      <li><a href="bootstrap/bootstrapToPage?pageFlag=gentellela_table_daletou">跳转测试2</a></li>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-bug"></i> 网络应用 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="gentellelaToPage?pageFlag=gentellela_table_daletou">娱乐活动</a></li>
                      <li><a href="projects.html">Projects</a></li>
                      <li><a href="project_detail.html">Project Detail</a></li>
                      <li><a href="contacts.html">Contacts</a></li>
                      <li><a href="profile.html">Profile</a></li>
